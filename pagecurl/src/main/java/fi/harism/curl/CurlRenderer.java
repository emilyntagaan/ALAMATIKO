...
//	}
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		gl.glClearColor(0f, 0f, 0f, 0f); // alpha = 0 → fully transparent

		// Enable smooth shading and alpha blending
		...
		// Disable depth and culling (we want flat transparent layers)
